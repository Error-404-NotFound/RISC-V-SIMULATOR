...
function check_assembly_content(assembly::String)::Bool
    ...
    for line in lines
        ...
        elseif current_section == ".text" && !startswith(directive, ".") && directive != ".word"
            ...
            instruction = parts[1]
            if instruction in ["add", "sub", "and", "or", "xor", "lw", "sw", "beq", "bne", "jal", "jr", "j", "li", "addi", "subi", "andi", "ori", "xori", "lui", "slti", "sltiu", "sll", "srl", "sra", "sllv", "srlv", "srav", "slt", "sltu","ecall","add_vec"]
