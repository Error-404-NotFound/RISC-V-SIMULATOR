...
function run_piped_wo_df(processor::Processor, variable_address::Dict{String, Int},index::Int, initial_address::Int64, cache_switch::Int) 
    while !processor.cores[index].write_back_last_instruction
        ...
        MEM_stage(processor, processor.cores[index], processor.memory, variable_address, cache_switch)
        ...
        IF_stage(processor, processor.cores[index], processor.memory, variable_address, initial_address, cache_switch)
...
function MEM_stage(processor::Processor, core::Core1, memory::Array{Int,2}, variable_address::Dict{String, Int}, cache_switch::Int)
...
function IF_stage(processor::Processor, core::Core1, memory::Array{Int,2}, variable_address::Dict{String, Int}, initial_address::Int64, cache_switch::Int)
